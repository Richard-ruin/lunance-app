class AppConfig {
  ...
  static const String _baseUrl = String.fromEnvironment(
    'BASE_URL',
    defaultValue: 'http://192.168.101.5:8000', // Default untuk development
  );
  
  static const String _wsUrl = String.fromEnvironment(
    'WS_URL', 
    defaultValue: 'ws://192.168.101.5:8000', // Default untuk development
  );
  ...
  static const bool enableWebSocketReconnect = bool.fromEnvironment('ENABLE_WS_RECONNECT', defaultValue: true);
  ...
  static const bool enableVoiceInput = bool.fromEnvironment('ENABLE_VOICE', defaultValue: false);
  static const bool enableImageUpload = bool.fromEnvironment('ENABLE_IMAGE_UPLOAD', defaultValue: false);
  static const bool enablePushNotifications = bool.fromEnvironment('ENABLE_NOTIFICATIONS', defaultValue: false);
  static const bool enableDarkMode = bool.fromEnvironment('ENABLE_DARK_MODE', defaultValue: true);
  ...
  static const bool enableCertificateValidation = bool.fromEnvironment('ENABLE_CERT_VALIDATION', defaultValue: true);
